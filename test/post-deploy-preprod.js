...
describe('Post-Deploy Tests on Preprod', () => {
  it('Helix Pages README', async () => {
    ...
    console.log(`Trying https://preprod.adobeioruntime.net/${getbaseurl()}?owner=adobe&repo=helix-pages&ref=17e0aeeb8639b8dae1c9243cf9fbd0042f564750&path=index.md`);
  ...
  it('Helix The Blog Excel', async () => {
    // eslint-disable-next-line no-console
    console.log(`Trying https://preprod.adobeioruntime.net/${getbaseurl()}?owner=adobe&repo=theblog&ref=master&path=/en/drafts/some-data-test.json`);
